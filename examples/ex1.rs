...
async fn main() {
    ...
    let x = t.tensor(vec![0.0, 1.0, 2.0, 3.0], vec![4], None);
    tensors_println!("{}", x);

    let x = t.tensor(vec![0.0, 1.0, 2.0, 3.0, 3.0, 4.0, 5.0, 6.0], vec![2, 4], None);
    println!("{}", x);

    let x = t.tensor(vec![0.0, 1.0, 2.0, 3.0, 3.0, 4.0, 5.0, 6.0], vec![2, 2, 2], None);
    println!("{}", x);
